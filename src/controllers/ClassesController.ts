...
export default class ClassesController {
  ...
  async create(request: Request, response: Response) {
    ...
    //trx (transaction) permite fazer todas as operações no banco simultaneamente, para assim n prendero servidor. e depois de tudo ser feito dar commit para alterar de fato o banco
    ...
    return response.status(201).send();
      ...
      //desfaz as alterações no banco caso haja erro
      await trx.rollback();
